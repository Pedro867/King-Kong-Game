	...
	for(int i = 0; i < 9; i++){
		for(int j = 0; j < 39; j++){
			if(i == 0){
				...
				chao.setPosition((window->getSize().x) * 3/20, alturaLinha + alturaLinha * i); //desenha no chao da linha
				...
				dimensoesChao.y = 5.f;
				chao.setSize(dimensoesChao);
				chao.setPosition((window->getSize().x) * 1/8, alturaLinha + alturaLinha * i);
				chao.setFillColor(sf::Color::Magenta);
				window->draw(chao);
				...
				parede1.setPosition((window->getSize().x) * 3/20, alturaLinha * i);
				parede1.setFillColor(sf::Color::Magenta);
				window->draw(parede1);

				parede2.setSize(dimensoesParedes);
				parede2.setOrigin(dimensoesParedes.x, 0);
				parede2.setPosition(window->getSize().x * 17/20, alturaLinha * i);
				...
				parede1.setSize(dimensoesParedes);
				parede1.setPosition((window->getSize().x) * 1/8, alturaLinha * i);
				parede1.setFillColor(sf::Color::Magenta);
				window->draw(parede1);

				parede2.setSize(dimensoesParedes);
				parede2.setOrigin(dimensoesParedes.x, 0);
				parede2.setPosition(window->getSize().x * 7/8, alturaLinha * i);
				parede2.setFillColor(sf::Color::Magenta);
				window->draw(parede2);
			}
			else if(i > 2 && i < 9){
				...
				dimensoesChao.y = 5.f;
				chao.setSize(dimensoesChao);
				chao.setPosition((window->getSize().x) * 1/10, alturaLinha + alturaLinha * i);
				chao.setFillColor(sf::Color::Magenta);
				window->draw(chao);
				...
				parede1.setSize(dimensoesParedes);
				parede1.setPosition((window->getSize().x) * 1/10, alturaLinha * i);
				parede1.setFillColor(sf::Color::Magenta);
				window->draw(parede1);

				parede2.setSize(dimensoesParedes);
				parede2.setOrigin(dimensoesParedes.x, 0);
				parede2.setPosition(window->getSize().x * 9/10, alturaLinha * i);
				parede2.setFillColor(sf::Color::Magenta);
				window->draw(parede2);
			}
		}
...
inline bool Cenario::testaColisao(){
